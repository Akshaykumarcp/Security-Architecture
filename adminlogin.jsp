...
<head>
  ...
  .s1
  {
  background:url(images/adminn.jpg) repeat;
  }
...
margin: 0;
  ...
  function valid1()
  {
  var a=document.admin.uname.value;
  if(a=="")
  {
  ...
  var b=document.admin.pass.value;
   if(b=="")
  {
...
<body>
<form name="admin" action="check.jsp" method="post" onsubmit="return valid1()" class="s1">
  ...
  <div id="site_content"> 
      ...
      <tr> 
        <td width="296"><p ><img src="images/admin1.png"  width="320" height="301" /> 
          </p></td>
        <td width="258" height="352"  > <form>
            <table>
              <tr> 
                <td colspan="2" align="center" > <strong><font face="mono"  size="+3" color="#FFA500">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ADMIN LOGIN</font></strong></td>
			   </tr>
			   <tr> 
