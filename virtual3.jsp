...
.b1
{
background:url(images/g.jpg) repeat;
}
...
<form  class="b1">
    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="requestsp1.jsp">Back</a></li>
        </ul>
      </div>
    </div>
    
  <div id="site_content">
      <h1 align="center"><font color="#FF3E96" size="+2" face="Courier New, Courier, mono"><strong>SERVICE 
  ...
  <tr>
          <td align="right"> <a href="requestsp2.1.jsp"><img src="images/continue.png" width="215" height="53" /></a></td>
  </tr>
  </table>  
